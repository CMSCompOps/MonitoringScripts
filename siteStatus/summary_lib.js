...
function writeNarrowTable() {

   // compose table header:
   var myTableStr = '<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">\n<TR' +
      '>\n   <TH NOWRAP ALIGN="left"><SPAN STYLE="font-size: 20px; font-weig' +
      'ht: bold">Sitename</SPAN>\n   <TH COLSPAN="3" NOWRAP ALIGN="center"><' +
      'SPAN STYLE="font-size: 14px; font-weight: bold">GGUS</SPAN>\n   <TH N' +
      'OWRAP ALIGN="center"><SPAN STYLE="font-size: 18px; font-weight: bold"' +
      '>Previous Month</SPAN>\n   <TH NOWRAP ALIGN="center"><SPAN STYLE="fon' +
      't-size: 18px; font-weight: bold">Previous Week</SPAN>\n   <TH NOWRAP ' +
      'ALIGN="center"><SPAN STYLE="font-size: 18px; font-weight: bold">Yeste' +
      'rday</SPAN>\n   <TH NOWRAP ALIGN="center"><SPAN STYLE="font-size: 18p' +
      'x; font-weight: bold">UTC Today</SPAN>\n   <TH NOWRAP ALIGN="center">' +
      '<SPAN STYLE="font-size: 18px; font-weight: bold">Following Week</SPAN' +
      '>\n';
   ...
   for ( var sCnt=0; sCnt < siteStatusData.length; sCnt+=1 ) {
      ...
      myTableStr += '   <TD><A CLASS="toolTip1" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec1" WIDTH="152" HEIGHT="18"></C' +
      ...
      myTableStr += '   <TD><A CLASS="toolTip3" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec3" WIDTH="122" HEIGHT="18"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
      ...
      myTableStr += '   <TD><A CLASS="toolTip4" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec4" WIDTH="218" HEIGHT="18"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
...
function writeWideTable() {

   // compose table header:
   var myTableStr = '<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0">\n<TR' +
      '>\n   <TH NOWRAP ALIGN="left"><SPAN STYLE="font-size: 28px; font-weig' +
      'ht: bold">Sitename</SPAN>\n   <TH COLSPAN="3" NOWRAP ALIGN="center"><' +
      'SPAN STYLE="font-size: 20px; font-weight: bold">GGUS</SPAN>\n   <TH N' +
      'OWRAP ALIGN="center"><SPAN STYLE="font-size: 24px; font-weight: bold"' +
      '>Previous Month</SPAN>\n   <TH NOWRAP ALIGN="center"><SPAN STYLE="fon' +
      't-size: 24px; font-weight: bold">Previous Week</SPAN>\n   <TH NOWRAP ' +
      'ALIGN="center"><SPAN STYLE="font-size: 24px; font-weight: bold">Yeste' +
      'rday</SPAN>\n   <TH NOWRAP ALIGN="center"><SPAN STYLE="font-size: 24p' +
      'x; font-weight: bold">UTC Today</SPAN>\n   <TH NOWRAP ALIGN="center">' +
      '<SPAN STYLE="font-size: 24px; font-weight: bold">Following Week</SPAN' +
      '>\n';
   ...
   for ( var sCnt=0; sCnt < siteStatusData.length; sCnt+=1 ) {
      ...
      // write first, site name, column:
      myTableStr += '<TR>\n   <TD ALIGN=\"left\"><A HREF=\"' + urlStr +
         '\"><SPAN STYLE="font-size: 22px; font-weight: bold">' + sName +
         '</SPAN></A>\n';
      ...
      // write third, previous month , column:
      myTableStr += '   <TD><A CLASS="toolTip1" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec1" WIDTH="392" HEIGHT="24"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
         'CING="0"><TR><TD COLSPAN="2" ALIGN="center"><B>Previous Month of ' +
         sName + '</B><TR><TD COLSPAN="2">&nbsp;<TR><TD COLSPAN="2"><CANVAS ' +
         'ID="cnvs_' + sName + '_mag1" WIDTH="540" HEIGHT="36"></CANVAS><TR>' +
      ...
      // write fourth, previous week , column:
      myTableStr += '   <TD><A CLASS="toolTip2" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec2" WIDTH="366" HEIGHT="24"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
         'CING="0"><TR><TD COLSPAN="2" ALIGN="center"><B>Previous Week of ' +
         sName + '</B><TR><TD COLSPAN="2">&nbsp;<TR><TD COLSPAN="2"><CANVAS ' +
         'ID="cnvs_' + sName + '_mag2" WIDTH="728" HEIGHT="36"></CANVAS><TR>' +
      ...
      // write fifth, yesterday, column:
      myTableStr += '   <TD><A CLASS="toolTip3" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec3" WIDTH="314" HEIGHT="24"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
         'CING="0"><TR><TD COLSPAN="2" ALIGN="center"><B>Yesterday (' +
         dateString2( siteStatusInfo['time'] - 86400 ) +
         ') of ' + sName + '</B><TR><TD COLSPAN="2">&nbsp;<TR><TD COLSPAN="2' +
      ...
      // write sixth, today, column:
      myTableStr += '   <TD><A CLASS="toolTip4" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec4" WIDTH="506" HEIGHT="24"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
         'CING="0"><TR><TD COLSPAN="2" ALIGN="center"><B>Today (' + 
         dateString2( siteStatusInfo['time'] ) +
         ') of ' + sName + '</B><TR><TD COLSPAN="2">&nbsp;<TR><TD COLSPAN="2' +
      ...
      // write seventh, following week, column:
      myTableStr += '   <TD><A CLASS="toolTip5" HREF="' + urlStr +
         '"><CANVAS ID="cnvs_' + sName + '_sec5" WIDTH="198" HEIGHT="24"></C' +
         'ANVAS><SPAN><TABLE WIDTH="100%" BORDER="0" CELLPADDING="0" CELLSPA' +
         'CING="0"><TR><TD COLSPAN="2" ALIGN="center"><B>Following Week of ' +
         sName + '</B><TR><TD COLSPAN="2">&nbsp;<TR><TD COLSPAN="2"><CANVAS ' +
         'ID="cnvs_' + sName + '_mag5" WIDTH="728" HEIGHT="36"></CANVAS><TR>' +
...
function fillNarrowCanvases() {
   ...
   for ( var sCnt=0; sCnt < siteStatusData.length; sCnt+=1 ) {
      ...
      mData = Math.min(cData.length, cDom.width / 1.25 );
      for ( var qday=0; qday < mData; qday+=1) {
         if ( qday % 4 == 0 ) {
            if ( (dataDay - 38 + Math.trunc(qday/4)) % 7 == 0 ) {
               ...
               cCtx.fillRect(qday+Math.trunc(qday/4),0,1,18);
            } else {
               // 75% tick at the start of a day
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qday+Math.trunc(qday/4),4,1,14);
            }
         }
         switch ( cData[ qday ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+qday+Math.trunc(qday/4),0,1,18);
               break;
            case "w":
            ...
            case "p":
               ...
               cCtx.fillRect(1+qday+Math.trunc(qday/4),0,1,6);
               cCtx.fillRect(1+qday+Math.trunc(qday/4),12,1,6);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qday+Math.trunc(qday/4),0,1,18);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qday+Math.trunc(qday/4),0,1,4);
               cCtx.fillRect(1+qday+Math.trunc(qday/4),6,1,2);
               cCtx.fillRect(1+qday+Math.trunc(qday/4),10,1,2);
               cCtx.fillRect(1+qday+Math.trunc(qday/4),14,1,4);
               break;
            case "W":
      ...
      for ( var qhour=0; qhour < mData; qhour+=1) {
         if ( qhour == 0 ) {
            if ( (dataDay - 1) % 7 == 0 ) {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qhour+Math.trunc(qhour/4),0,1,18);
            } else {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qhour+Math.trunc(qhour/4),4,1,14);
            }
         } else if ( qhour % 24 == 0 ) {
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(qhour+Math.trunc(qhour/4),9,1,9);
         } else if ( qhour % 4 == 0 ) {
            // 25% tick at the start of an hour
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(qhour+Math.trunc(qhour/4),14,1,4);
         }
         switch ( cData[ qhour ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),0,1,18);
               break;
            case "w":
               cCtx.fillStyle = "#FFFF00";
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),0,1,18);
            ...
            case "p":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),0,1,6);
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),12,1,6);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),0,1,18);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),0,1,4);
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),6,1,2);
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),10,1,2);
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),14,1,4);
               break;
            case "W":
               cCtx.fillStyle = "#A000A0";
               cCtx.fillRect(1+qhour+Math.trunc(qhour/4),0,1,18);
...
function fillWideCanvases() {
   ...
   for ( var sCnt=0; sCnt < siteStatusData.length; sCnt+=1 ) {
      ...
      for ( var qday=0; qday < mData; qday+=1) {
         if ( qday % 4 == 0 ) {
            if ( (dataDay - 38 + Math.trunc(qday/4)) % 7 == 0 ) {
               // full scale tick at the start of the week, Sunday-to-Monday
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qday*3+Math.trunc(qday/4),0,1,24);
            } else {
               // 75% tick at the start of a day
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qday*3+Math.trunc(qday/4),6,1,18);
            }
         }
         switch ( cData[ qday ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),0,3,24);
               break;
            case "w":
               cCtx.fillStyle = "#FFFF00";
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),0,3,24);
            ...
            case "p":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),0,3,8);
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),16,3,8);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),0,3,24);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),0,3,5);
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),8,3,3);
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),13,3,3);
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),19,3,5);
               break;
            case "W":
               cCtx.fillStyle = "#A000A0";
               cCtx.fillRect(1+qday*3+Math.trunc(qday/4),0,3,24);
      ...
      cDom = document.getElementById('cnvs_' + sName + '_sec2');
      cCtx = cDom.getContext("2d");
      mData = Math.min(cData.length, cDom.width / 2.166 );
      for ( var hour=0; hour < mData; hour+=1) {
         if ( hour % 24 == 0 ) {
            if ( (dataDay - 8 + Math.trunc(hour/24)) % 7 == 0 ) {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(hour*2+Math.trunc(hour/6),0,1,24);
            } else {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(hour*2+Math.trunc(hour/6),6,1,18);
            }
         } else if ( hour % 6 == 0 ) {
            // 50% tick at the start of a six-hour/quarter-day period
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(hour*2+Math.trunc(hour/6),12,1,12);
         }
         switch ( cData[ hour ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),0,2,24);
               break;
            case "w":
               cCtx.fillStyle = "#FFFF00";
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),0,2,24);
            ...
            case "p":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),0,2,8);
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),16,2,8);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),0,2,24);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),0,2,5);
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),8,2,3);
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),13,2,3);
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),19,2,5);
               break;
            case "W":
               cCtx.fillStyle = "#A000A0";
               cCtx.fillRect(1+hour*2+Math.trunc(hour/6),0,2,24);
      ...
      for ( var qhour=0; qhour < mData; qhour+=1) {
         if ( qhour == 0 ) {
            if ( (dataDay - 1) % 7 == 0 ) {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qhour*3+Math.trunc(qhour/4),0,1,24);
            } else {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qhour*3+Math.trunc(qhour/4),6,1,18);
            }
         } else if ( qhour % 24 == 0 ) {
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(qhour*3+Math.trunc(qhour/4),12,1,12);
         } else if ( qhour % 4 == 0 ) {
            // 25% tick at the start of an hour
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(qhour*3+Math.trunc(qhour/4),18,1,6);
         }
         switch ( cData[ qhour ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),0,3,24);
               break;
            case "w":
               cCtx.fillStyle = "#FFFF00";
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),0,3,24);
            ...
            case "p":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),0,3,8);
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),16,3,8);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),0,3,24);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),0,3,5);
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),8,3,3);
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),13,3,3);
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),19,3,5);
               break;
            case "W":
               cCtx.fillStyle = "#A000A0";
               cCtx.fillRect(1+qhour*3+Math.trunc(qhour/4),0,3,24);
      ...
      cDom = document.getElementById('cnvs_' + sName + '_sec4');
      cCtx = cDom.getContext("2d");
      mData = Math.min(cData.length, cDom.width / 5.25 );
      for ( var qhour=0; qhour < mData; qhour+=1) {
         if ( qhour == 0 ) {
            if ( dataDay % 7 == 0 ) {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qhour*5+Math.trunc(qhour/4),0,1,18);
            } else {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(qhour*5+Math.trunc(qhour/4),4,1,14);
            }
         } else if ( qhour % 24 == 0 ) {
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(qhour*5+Math.trunc(qhour/4),9,1,9);
         } else if ( qhour % 4 == 0 ) {
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(qhour*5+Math.trunc(qhour/4),14,1,4);
         }
         switch ( cData[ qhour ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),0,5,24);
               break;
            case "w":
               cCtx.fillStyle = "#FFFF00";
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),0,5,24);
            ...
            case "p":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),0,5,8);
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),16,5,8);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),0,5,24);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),0,5,5);
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),8,5,3);
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),13,5,3);
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),19,5,5);
               break;
            case "W":
               cCtx.fillStyle = "#A000A0";
               cCtx.fillRect(1+qhour*5+Math.trunc(qhour/4),0,5,24);
      ...
      for ( var hour=0; hour < mData; hour+=1) {
         if ( hour % 24 == 0 ) {
            if ( (dataDay + 1 + Math.trunc(hour/24)) % 7 == 0 ) {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(hour+Math.trunc(hour/6),0,1,24);
            } else {
               cCtx.fillStyle = "#000000";
               cCtx.fillRect(hour+Math.trunc(hour/6),6,1,18);
            }
         } else if ( hour % 6 == 0 ) {
            // 50% tick at the start of a six-hour/quarter-day period
            cCtx.fillStyle = "#000000";
            cCtx.fillRect(hour+Math.trunc(hour/6),12,1,12);
         }
         switch ( cData[ hour ] ) {
            case "o":
               cCtx.fillStyle = "#80FF80";
               cCtx.fillRect(1+hour+Math.trunc(hour/6),0,4,24);
               break;
            case "w":
               cCtx.fillStyle = "#FFFF00";
               cCtx.fillRect(1+hour+Math.trunc(hour/6),0,4,24);
            ...
            case "p":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+hour+Math.trunc(hour/6),0,4,8);
               cCtx.fillRect(1+hour+Math.trunc(hour/6),16,4,8);
               break;
            case "d":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+hour+Math.trunc(hour/6),0,4,24);
            ...
            case "a":
               cCtx.fillStyle = "#6080FF";
               cCtx.fillRect(1+hour+Math.trunc(hour/6),0,4,5);
               cCtx.fillRect(1+hour+Math.trunc(hour/6),8,4,3);
               cCtx.fillRect(1+hour+Math.trunc(hour/6),13,4,3);
               cCtx.fillRect(1+hour+Math.trunc(hour/6),19,4,5);
               break;
            case "W":
               cCtx.fillStyle = "#A000A0";
               cCtx.fillRect(1+hour+Math.trunc(hour/6),0,4,24);
