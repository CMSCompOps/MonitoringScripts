...
python /afs/cern.ch/user/c/cmst1/scratch0/MonitoringScripts/morgue/morgue.py &> /afs/cern.ch/user/c/cmst1/scratch0/MonitoringScripts/morgue/morgue.log
cp /afs/cern.ch/user/c/cmst1/scratch0/MonitoringScripts/morgue/morgue.txt /afs/cern.ch/user/c/cmst1/www/SST/