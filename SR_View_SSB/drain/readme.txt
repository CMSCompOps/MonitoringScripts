...
# Script is located : /afs/cern.ch/user/c/cmst1/scratch0/MonitoringScripts/SR_View_SSB/drain
# Outputs : 
   # /afs/cern.ch/user/c/cmst1/www/SST/drain.txt (https://cmst1.web.cern.ch/CMST1/SST/drain.txt)
