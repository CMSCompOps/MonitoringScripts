...
1. To move a site IN the WR
comment (#) the line with the name of the site in the file: 
	Output copy used by SSB

2. To move a site OUT of the WR
...
--- PROCEDURE TO CHANGE THE SCRIPT ---
...
2. cd /afs/cern.ch/cms/LCG/SiteComm/MonitoringScripts/
...
6. IMPORTANT: push your changes to github (create a pull request)
	...
	git push
7. *** If your changes are working and you pull request is accepted
	REDEPLOY THE SCRIPT IN THE SCRIPT LOCATION THAT IS READ BY THE ACRONTAB
