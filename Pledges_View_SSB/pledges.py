...
def matchPledges(pledgeList):
  ...
  matchList = {"T1_TW_ASGC": "ASGC", 
               "T1_FR_CCIN2P3": "CC-IN2P3", 
               "T1_CH_CERN": "CERN",
               "T1_IT_CNAF": "CNAF",
               "T1_US_FNAL": "FNAL",
               "T1_US_FNAL_Disk": "n/a",
               "T1_RU_JINR": "JINR-T1",
               "T1_RU_JINR_Disk": "JINR-T1DISK",
               "T1_DE_KIT": "KIT",
               "T1_ES_PIC": "PIC",
               "T1_UK_RAL": "RAL",
               "T1_UK_RAL_Disk": "n/a",
               "T2_IT_Bari": "Bari",
               "T2_CN_Beijing": "Beijing",
               "T2_K_SGrid_Bristol": "Bristol",
               "T2_K_London_Brunel": "Brunel",
               "T2_FR_CCIN2P3": "CC-IN2P3 AF",
               "T2_CH_CERN": "n/a",
               "T2_CH_CERN_AI": "n/a",
               "T2_CH_CERN_HLT": "n/a",
               "T2_CH_CERN_T0": "n/a",
               "T2_ES_CIEMAT": "CIEMAT",
               "T2_CH_CSCS": "CSCS",
               "T2_TH_CUNSTDA": "CUNSTDA",
               "T2_S_Caltech": "Caltech",
               "T2_DE_DESY": "DESY",
               "T2_EE_Estonia": "Estonia",
               "T2_S_Florida": "Florida",
               "T2_FR_GRIF_IRFU": "GRIF_IRFU",
               "T2_FR_GRIF_LLR": "GRIF_LLR",
               "T2_BR_UERJ": "HEPGRID_UERJ",
               "T2_FI_HIP": "Helsinki Institute of Physics",
               "T2_AT_Vienna": "Hephy-Vienna",
               "T2_HU_Budapest": "Hungary",
               "T2_UK_London_IC": "IC",
               "T2_ES_IFCA": "IFCA",
               "T2_RU_IHEP": "IHEP",
               "T2_BE_IIHE": "IIHE",
               ...
               "T2_FR_IPHC": "IPHC",
               "T2_RU_ITEP": "ITEP",
               "T2_GR_Ioannina": "Ioannina",
               "T2_RU_JINR": "JINR",
               "T2_UA_KIPT": "KIPT", 
               "T2_KR_KNU": "KNU",
               "T2_IT_Legnaro": "Legnaro",
               "T2_BE_UCL": "Louvain",
               "T2_TR_METU": "METU", 
               "T2_US_MIT": "MIT", 
               "T2_PT_NCG_Lisbon": "NCG-INGRID-PT",
               "T2_PK_NCP": "NCP-LCG2",
               ...
               "T2_DE_RWTH": "RWTH",
               "T2_IT_Rome": "Rome",
               "T2_UK_SGrid_RALPP": "Rutherford PPD",
               "T2_RU_SINP": "SINP",
               "T2_BR_SPRACE": "SPRACE",
               "T2_IN_TIFR": "TIFR",
               "T2_TW_Taiwan": "Taiwan",
               "T2_US_UCSD": "UCSD",
               "T2_MY_UPM_BIRUNI": "n/a" ,
               "T2_US_Vanderbilt": "n/a",
               "T2_PL_Warsaw": "Warsaw",
               "T2_US_Wisconsin": "Wisconsin" 
               }
  for site in matchList:
    if pledgeList.has_key(matchList[site]):
      pledges[site] = pledgeList[matchList[site]]
    else:
      pledges[site] = "n/a"
  return pledges
