...
hcURL="http://dashb-cms-job.cern.ch/dashboard/request.py/jobsummary-plot-or-table?activity=hctest&date1={0}&date2={1}&sortby=site&scale=linear&check=terminated"
