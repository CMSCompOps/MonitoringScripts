	...
	s_status=output_list[2]
	   ...
	   startingComma=","
        ...
        json_site_part= startingComma+"{\"site\":\""+str(site)+"\""      \
              +",\"Pending\":\""+str(dict_pen[site]['Processing']+dict_pen[site]['Production']+dict_pen[site]['Merge']+dict_pen[site]['Cleanup']+dict_pen[site]['LogCollect'])+"\""        \
              +",\"TimeDate\":\""+str(currTime.strip())+"\"" \
              +",\"Running\":\""+str(dict_run[site]['Processing']+dict_run[site]['Production']+dict_run[site]['Merge']+dict_run[site]['Cleanup']+dict_run[site]['LogCollect'])+"\""        \
