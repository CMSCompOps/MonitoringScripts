...
def lftch_maindvi_sam(cfg, docs):
    ...
    # ################################################################ #
    LFTCH_SAM3HEAT = "http://wlcg-sam-cms.cern.ch/templates/ember/#/historicalsmry/heatMap?profile=CMS_CRITICAL_FULL&start_time=%s&end_time=%s&%s=%s&time=manual&view=Test History"
    #
    siteRegex = re.compile(r"T\d_[A-Z]{2,2}_\w+")
